...
fig.suptitle("Tokyo daily averages of temperature from January 1, 2018")
ax1 = fig.add_subplot(2,1,1)
ax1.plot(x_fft, datalist1)
ax1.plot(x_fft, wavelist)
plt.title("Actual (Day 0 - 364) and Low-passed Line by Fourier Series")
plt.xlabel("Days")
...
plt.title("Actual (Day 0 -) and Nonlinear Regression Line (Prediction: Day 365 -)")
